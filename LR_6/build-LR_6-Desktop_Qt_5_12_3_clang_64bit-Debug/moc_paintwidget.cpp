...
QT_MOC_LITERAL(3, 27, 11) // "seedChanged"

    },
    "PaintWidget\0pointsChanged\0\0seedChanged"
};
...
void PaintWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pointsChanged((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        case 1: _t->seedChanged((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PaintWidget::*)(const int & , const int & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PaintWidget::pointsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PaintWidget::*)(const QPoint & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PaintWidget::seedChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void PaintWidget::pointsChanged(const int & _t1, const int & _t2)
{
...
// SIGNAL 1
void PaintWidget::seedChanged(const QPoint & _t1)
{
